...
import pkg.celery_queue.client as celery_client_module
...
def test_submit_generates_traceable_task_id_and_merges_headers(
    celery_client: CeleryClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    send_task = MagicMock(return_value=object())
    monkeypatch.setattr(celery_client.app, "send_task", send_task)
    monkeypatch.setattr(celery_client_module, "uuid", MagicMock(return_value="generated-123"))
    ...
    send_task.assert_called_once_with(
        ...
        kwargs={},
        queue="default",
        task_id="send_welcome_email_caller-trace-id_generated-123",
